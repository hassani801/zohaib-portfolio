...
export const industries = [
  {
    ...
    tags: [
      ["Patient UX", "Accessibility", "Data Clarity"],
      ["Compliance UX", "Health Data", "Clinical Workflows"],
    ],
  ...
  },
  {
    ...
    tags: [
      ["Secure UX", "Data Visualisation", "Trust Design"],
      ["Dashboards", "Financial UX", "Risk & Security"],
    ],
  ...
  },
  {
    ...
    tags: [
      ["Conversion UX", "Checkout Flow", "Product Discovery"],
      ["Shopping Flow", "Retention UX", "Conversion Design"],
    ],
  ...
  },
  {
    ...
    tags: [
      ["Product UX", "Feature Design", "Growth Systems"],
      ["Dashboard UX", "Workflow Design", "Scalable Systems"],
    ],
  ...
  },
  {
    ...
    tags: [
      ["B2B UX", "Workflow Design", "Dashboard UX"],
      ["System Design", "Operational UX", "Workflow Clarity"],
    ],
